package supercoder79.superworldgen.noise.gradient;

import supercoder79.superworldgen.noise.Noise;
 ...
 */
public class SimplexStyleNoise extends Noise {
    ...
    public SimplexStyleNoise(long seed) {
        super(seed);
